...
public:
    ...
    {
        assert(m_current != m_end && "ArrayRange start and end cannot be equal");
    ...
    namespace Benchmark {
        namespace Detail {
            ...
            struct ObjectStorage
            {
                ...
                ObjectStorage() : holder() {}

                ObjectStorage(const ObjectStorage& other)
                {
                    new(&holder) T(other.stored_object());
                }

                ObjectStorage(ObjectStorage&& other)
                {
                    new(&holder) T(std::move(other.stored_object()));
                }
            ...
            private:
                ...
                T& stored_object() {
                    return *static_cast<T*>(static_cast<void*>(&holder));
                }
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t idx = 0; idx < m_str.size(); ++ idx ) {
            ...
            default:
                ...
                // The header is valid, check holder
